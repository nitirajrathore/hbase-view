...
public class ServiceFormattedException extends WebApplicationException {
  public ServiceFormattedException() {
  }

  public ServiceFormattedException(Response response) {
    super(response);
  }

  public ServiceFormattedException(int status) {
    super(status);
  }

  public ServiceFormattedException(Response.Status status) {
    super(status);
  }

  public ServiceFormattedException(Throwable cause) {
    super(cause);
  }

  public ServiceFormattedException(Throwable cause, Response response) {
    super(cause, response);
  }

  public ServiceFormattedException(Throwable cause, int status) {
    super(cause, status);
  }

  public ServiceFormattedException(Throwable cause, Response.Status status) {
    super(cause, status);
  }
